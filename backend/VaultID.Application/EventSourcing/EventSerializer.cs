...
public sealed class EventSerializer
{
    ...
    private static readonly IReadOnlyDictionary<string, Type> EventTypes =
        new Dictionary<string, Type>
        {
            ...
            [nameof(CollectionItemAdded)] = typeof(CollectionItemAdded),
            [nameof(CollectionItemRemoved)] = typeof(CollectionItemRemoved),
            [nameof(CollectionItemFieldUpdated)] = typeof(CollectionItemFieldUpdated),
