...
const FIELD_DISPLAY_NAMES: Record<string, string> = {
  ...
  EmergencyContacts: 'Emergency contacts / next of kin',
  NextOfKin: 'Next of kin',
  Relationship: 'Relationship',
  // Address parts, shared by the physical and postal address groups
...
export const CATEGORY_META: Record<string, CategoryMeta> = {
  ...
  Financial: {
    label: 'Financial',
    icon: 'ph-bank',
    dot: 'var(--vid-cat-financial)',
    bg: 'var(--vid-cat-financial-bg)',
    text: 'var(--vid-cat-financial-text)',
  },
  Religious: {
    label: 'Religious',
    icon: 'ph-hands-praying',
    dot: 'var(--vid-cat-religious)',
    bg: 'var(--vid-cat-religious-bg)',
    text: 'var(--vid-cat-religious-text)',
  },
};
